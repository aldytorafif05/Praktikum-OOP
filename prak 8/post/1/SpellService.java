class SpellService {
    public static void comboSpell(Character caster, int spell1Cost, int spell2Cost) throws SpellCastFailedException {
        ...
        catch (InsufficientManaException s){
            throw new SpellCastFailedException("Combo gagal saat cast spell pertama oleh " + caster.getName(), s);
        }
        catch (InvalidManaAmountException s){
            throw new SpellCastFailedException("Combo gagal saat cast spell pertama oleh " + caster.getName(), s);
        ...
        try {
            ...
            throw new SpellCastFailedException("Combo gagal saat cast spell kedua oleh " + caster.getName(), s);
        }
        catch (InvalidManaAmountException s){
            throw new SpellCastFailedException("Combo gagal saat cast spell kedua oleh " + caster.getName(), s);
