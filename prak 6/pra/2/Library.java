...
public class Library {
    ...
    public void findBook(String title){
        ...
        for (Section s : sections){
            for (Section.Book b : s.books){
                if (b.getTitle().equals(title)){
                    System.out.println("Found " + title + " in " + s.getSectionName() + " section");
                    b.getDetails();
                    found = true;
                }
            }
    ...
    public static class Section {
        ...
        public void addBook(Book book){
            books.add(book);
            System.out.println("Book " + book.title + " added to " + sectionName + " section");
        }
        ...
        public void removeBook(String title){
            ...
            for (Book b : books){
                if (b.title.equals(title)){
                    books.remove(b);
                    System.out.println("Book " + b.title + " removed from " + sectionName + " section");
                    found = true;
                }
            }
            if (found == false){
        ...
        public class Book {
            ...
            public String getDetails(){
                if (isAvailable == true){
                    return "Book " + title + " by " + author + " [Available] - Section: " + sectionName;
                }
                else {
                    return "Book " + title + " by " + author + " [Borrowed by " + borrowedBy + "] - Section: " + sectionName; 
                }
            }
    ...
    public static class Member {
        ...
        public void displayBorrowedBooks(){
            ...
            if (borrowedBooks.size() == 0){
                ...
                for (Section.Book b : borrowedBooks){
