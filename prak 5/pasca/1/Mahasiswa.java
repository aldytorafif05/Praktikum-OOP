public abstract class Mahasiswa implements User {    
    ...
    */
    Mahasiswa(){
        // TODO: answer here
        this.userId = String.format("1%05d", mahasiswaCounter + 1);
        this.username = null;
        this.password = null;
        this.assigned = false;
        mahasiswaCounter++;
    ...
    */
    public void login(String username, String password) {
        ...
        else if (isRegistered() && this.username.equals(username) && this.password.equals(password)){
    ...
    */
    public void login(String ssoSlug) {
        ...
        else if (ssoSlug.equals(this.userId + "-" + this.username)){
            System.out.println("Login berhasil");
            perkenalkan();
        }
        else {
