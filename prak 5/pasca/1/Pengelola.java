public final class Pengelola implements User {
    ...
    public Pengelola() {
        ...
        this.username = null;
        this.password = null;
        this.NIP = String.format("2%05d", pengelolaCounter + 1);
        pengelolaCounter++;
    }
    ...
    public void register(String username, String password) {
        // TODO: answer here
        if(isRegistered()){
            System.out.println("Pengelola dengan username " + username + " sudah terdaftar");
        }
        else{
    ...
    */
    ...
    public void terimaPendaftaran(Mahasiswa mhs, Asrama asrama) {
        // TODO: answer here
        if (mhs.getAsrama() != null && mhs.getAsrama() == asrama){
