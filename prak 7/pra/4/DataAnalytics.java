...
public class DataAnalytics {
    ...
    // Signature: public static <T> void copyData(Container<? extends T> source,
    // Container<? super T> destination)
    // Pertanyaan: Mengapa source menggunakan "? extends T" dan destination "? super
    // T"?
    ...
    //
    // Implementasi:
    // - Tampilkan: "Menyalin data dari [source.getName()] ke
    // [destination.getName()]..."
    ...
    // Signature: public static <T> Container<T> mergeContainers(Container<? extends
    // T> c1, Container<? extends T> c2, String newName)
    // Pertanyaan: Mengapa kedua parameter menggunakan "? extends T"?
    // Hint: Apa operasi yang kita lakukan pada c1 dan c2? Apakah kita memodifikasi
    // mereka?
    //
    // Implementasi:
    ...
    public static <T> Container<T> mergeContainers(Container<? extends T> c1, Container<? extends T> c2, String newName){
        Container<T> newContainer = new Container<T>(newName);
    ...
    // Hint: Apakah tipe spesifik T penting untuk operasi print? Apakah semua tipe
    // bisa di-print?
    //
    // Implementasi:
